                ...
                <div class="row text-white py-5">
                    ...
                    <div class="col-6 d-none d-sm-block col-sm-4 col-lg-3">
                        ...
                        <ul class="pl-0 list-unstyled">
                            <li class="whiteDark"><a href="#" class="f-16">Privacy Policy</a></li>
                            <li class="whiteDark"><a href="#" class="f-16">Terms & Conditions</a></li>
                            <li class="whiteDark"><a href="#" class="f-16">Contact Us</a></li>
                            <li class="whiteDark"><a href="#" class="f-16">Our Sitemap</a></li>
                            <li class="whiteDark"><a href="#" class="f-16">Latest News</a></li>
                    ...
                    <div class="col-6 d-none d-lg-block col-lg-3">
                        ...
                        <div id="box" class="d-flex flex-column justify-content-between">
                            ...
                            <div class="d-flex justify-content-between h-33">
                                <div class="mr-1 w-100 h-100 bgGrey">  </div>
                                <div class="mr-1 w-100 h-100 bg-info text-center d-flex flex-column justify-content-center"> <div><a class="text-white" > <i class="fab fa-instagram f-24"></i></a> </div> </div>
                                <div class="mr-1 w-100 h-100 bgGrey">  </div>
                            </div>
                            <div class="d-flex justify-content-between h-33 ">
                                <div class="mr-1 w-100 h-100 bgGrey">  </div>
