    ...
    <div class="row">
      <div class="col">
        ...
        <div class="overflow-auto myheigth">
          <p>
            This privacy policy ("policy") will help you understand how Kenkata
            uses and protects the data you provide to us when you visit and use
            Kenkata ("website", "service").
          </p>
          <p>
          ...
          <div>
            ...
            <p>
              Kenkata is committed to securing your data and keeping it
              confidential. Kenkata has done all in its power to prevent data
          ...
          <div>
            ...
            <p>
              ...
              agreement. Make sure to read the privacy policy documentation of
          ...
          <div>
            ...
            <p>
              Kenkata will not lease, sell or distribute your personal
